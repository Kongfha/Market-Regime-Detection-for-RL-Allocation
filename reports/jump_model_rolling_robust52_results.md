...
- `output/jump_model_rolling_robust52/jump_model_assignments.csv`
- `output/jump_model_rolling_robust52/jump_model_metrics.csv`
- `output/jump_model_rolling_robust52/jump_model_regime_summary.csv`
- `output/jump_model_rolling_robust52/jump_model_feature_profile.csv`
- `output/jump_model_rolling_robust52/jump_model_pca_loadings.csv`
- `output/jump_model_rolling_robust52/elbow_diagnostics.html`
- `output/jump_model_rolling_robust52/cluster_scatter.html`
- `output/jump_model_rolling_robust52/regime_timeline.html`
- `output/jump_model_rolling_robust52/feature_profile.html`
